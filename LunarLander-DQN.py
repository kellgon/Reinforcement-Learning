...
if __name__ == '__main__':
    ...
    plot(pd.DataFrame(rewards_list), "Training Data", "Training Data", "Episode", "Reward")
    
    #test the trained model
    test_rewards = test_model(trained_model, env)
    
    #print rewards for each testing episode
    plot(pd.DataFrame(test_rewards), "Testing Data", "Testing Data", "Episode", "Reward")
    
    print("The average reward for this model is ", np.mean(test_rewards))
